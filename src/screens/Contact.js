    ...
    <ScrollView>
      <View style={styles.mainContainer}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput style={styles.inputStyle} placeholder={'demo@mail.com'} placeholderTextColor='#808080'
        ...
        <TouchableOpacity style={[styles.buttonStyle, { backgroundColor: agree ? "#4630EB" : 'grey', }]} onPress={() => navigation.navigate('Home')} disabled={!agree} >
